...
while win == False and tries < 7:
	try:
		...
		while(inpt > 100):
			inpt = int(input("Please input a number BETWEEN 1 and 100 and not higher than 100: "))
		while(inpt < 1):
			inpt = int(input("Please input a number BETWEEN 1 and 100 and not lower than 100: "))
